            ...
            <div class="col-md-8">
                <ul class="ps-0" style="list-style: none;">
                    <li class="d-flex align-items-start mb-2">
                        <span class="me-2 text-success fs-5">✅</span> Aspirateurs industriels ultra-puissants
                    </li>
                    <li class="d-flex align-items-start mb-2">
                        <span class="me-2 text-success fs-5">✅</span> Nettoyeurs vapeur haute pression
                    </li>
                    <li class="d-flex align-items-start mb-2">
                        <span class="me-2 text-success fs-5">✅</span> Autolaveuses pour grandes surfaces
                    </li>
                    <li class="d-flex align-items-start mb-4">
                        <span class="me-2 text-success fs-5">✅</span> Matériel spécialisé pour vitres et sols délicats
                    </li>
                </ul>
                ...
                <ul class="ps-0" style="list-style: none;">
                    <li class="d-flex align-items-start mb-2">
                        <span class="me-2 text-success fs-5">🌿</span> Produits respectueux de l’environnement (Ecolabel Européen)
                    </li>
                    <li class="d-flex align-items-start mb-2">
                        <span class="me-2 text-success fs-5">🧼</span> Détergents et désinfectants conformes aux normes
                    </li>
                    <li class="d-flex align-items-start mb-4">
                        <span class="me-2 text-success fs-5">🧪</span> Produits hypoallergéniques sans danger pour tous
                    </li>
                </ul>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              ...
              <p class="mb-1">
                ...
                <a href="tel:+0783236403" class="text-decoration-none text-dark">0783236403</a>
              </p>
              <p class="mb-0">
                <i class="bi bi-envelope-fill"></i> 
                <a href="mailto:Allcleanservice@gmail.com" class="text-decoration-none text-dark">Allcleanservice@gmail.com</a>
              </p>
              <p><i class="bi bi-clock-fill"></i> Lundi au Vendredi : 08h00 - 18h00</p>
            </div>
      
            <!-- Colonne droite : Nos services -->
            <div class="col-md-4">
                <h5 class="text-uppercase mb-3">Nos services</h5>
                <ul class="list-unstyled">
                  <li>
                    <a href="#vitres" class="text-decoration-none text-white">
                      <i class="bi bi-aspect-ratio-fill"></i> Nettoyage de vitres
                    </a>
                  </li>
                  <li>
                    <a href="#sol" class="text-decoration-none text-white">
                      <i class="bi bi-grid-fill"></i> Nettoyage de tout sol
                    </a>
                  </li>
                  <li>
                    <a href="#vehicule" class="text-decoration-none text-white">
                      <i class="bi bi-truck-front-fill"></i> Nettoyage intérieur de véhicule
                    </a>
                  </li>
                  <li>
                    <a href="#bureaux" class="text-decoration-none text-white">
                      <i class="bi bi-building"></i> Nettoyage de bureaux, locaux, société
                    </a>
                  </li>
                  <li>
                    <a href="#espaces-verts" class="text-decoration-none text-white">
                      <i class="bi bi-tree-fill"></i> Entretien espaces verts
                    </a>
                  </li>
                  <li>
                    <a href="#chantier" class="text-decoration-none text-white">
                      <i class="bi bi-hammer"></i> Nettoyage après chantier
                    </a>
                  </li>
                  <li>
                    <a href="#maison" class="text-decoration-none text-white">
                      <i class="bi bi-house-heart-fill"></i> Entretien maison
                    </a>
                  </li>
                  <li>
                    <a href="#copropriete" class="text-decoration-none text-white">
                      <i class="bi bi-people-fill"></i> Entretien copropriété
                    </a>
                  </li>
                </ul>
